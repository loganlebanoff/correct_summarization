...
temp_in_dir = os.path.join(lambdamart_in_dir, exp_name)
temp_out_dir = os.path.join(lambdamart_out_dir, exp_name)
...
def get_features_all_combinations(raw_article_sents, article_sent_tokens, corefs, mmrs, single_feat_len, pair_feat_len, singles_and_pairs):
...
def generate_summary_importance(raw_article_sents, article_sent_tokens, corefs, temp_in_path, temp_out_path, single_feat_len, pair_feat_len, singles_and_pairs):
    tfidfs = util.get_tfidf_importances(tfidf_vectorizer, raw_article_sents)
    instances = get_features_all_combinations(raw_article_sents, article_sent_tokens, corefs, tfidfs, single_feat_len, pair_feat_len, singles_and_pairs)
