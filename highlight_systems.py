...
if 'only_pairs' not in flags.FLAGS:
    flags.DEFINE_boolean('only_pairs', False, 'Run with only_pairs=False first, then only_pairs=True')
...
def main(unused_argv):
    ...
    if not FLAGS.only_pairs:
        ...
        w_article = open(os.path.join(pairs_only_processed_root, 'articles.txt'), 'w')
        ...
        w_system = open(os.path.join(pairs_only_processed_root, 'systems.txt'), 'w')
