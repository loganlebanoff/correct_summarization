...
def plot_histograms(all_list_of_hist_pairs):
    ...
    pp = PdfPages(os.path.join('stuff/plots', FLAGS.dataset_name + '_' + FLAGS.dataset_split + '.pdf'))
...
def plot_histogram(ax, row_idx, col_idx, lst=None, num_bins=None, start_at_0=False, pdf=False, cutoff_std=4, log=False, max_val=None, y_label=None, x_label=None, y_lim=None):
    def plot(my_lst, translucent=False):
        ...
        ax.hist(my_lst, bins=bins, density=pdf, alpha=alpha, histtype=histtype, edgecolor='black', log=log)
...
def main(unused_argv):
    ...
    for dataset_name in dataset_names:
        ...
        #     example = example_idx_example
            ...
            rel_sent_indices, doc_sent_indices, doc_sent_lens = preprocess_for_lambdamart_no_flags.get_rel_sent_indices(doc_indices, article_sent_tokens)
