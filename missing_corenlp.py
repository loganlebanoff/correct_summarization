...
with open("/home/logan/discourse/data/coref/xsum/corenlp_lists/all_train.txt") as f:
  urls = f.readlines()
necessary_urls = []
for url in urls:
  # Get file id
...
with open("/home/logan/discourse/data/coref/xsum/corenlp_lists/missing_list.txt", "wb") as f:
