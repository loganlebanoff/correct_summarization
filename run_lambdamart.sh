...
java -Xmx120g -jar /home/logan/ranklib/bin/RankLib-2.10.jar -train data/to_lambdamart/"$DATASET_NAME"_"$SINGLES_AND_PAIRS"/train_10000.txt -ranker 6 -metric2t NDCG@5 -metric2T NDCG@5 -save data/lambdamart_models/"$DATASET_NAME"_ndcg5_"$SINGLES_AND_PAIRS"_10000_tree100.txt -sparse -estop 50 -leaf 10 -tree 50
